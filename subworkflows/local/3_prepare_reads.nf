...
include { UMITOOLS_EXTRACT } from "${projectDir}/modules/nf-core/modules/umitools/extract/main"
include { TRIMMOMATIC      } from "${projectDir}/modules/nf-core/modules/trimmomatic/main"
...
workflow PREPARE_READS {
    ...
    // if reduce_to_se is NOT set, then return the output of umitools extract
    // as is
    } else{
